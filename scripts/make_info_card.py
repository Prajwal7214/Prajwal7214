...
# ===========================================================================
HOST = "Prajwal7214"   # shown as  you@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Full Stack Developer Intern @ Ateion"),
    ("kv", "Also", "AI/ML Intern @ Infosys Springboard"),
    ("kv", "Edu", "Computer Engineering Student"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React.js, JavaScript, Tailwind CSS"),
    ("kv", "Backend", "Node.js, Express.js, Django, FastAPI"),
    ("kv", "AI / ML", "RAG, LangChain, FAISS, Hugging Face"),
    ("kv", "Databases", "PostgreSQL, MongoDB, SQL"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Summarix – AI-powered document assistant with RAG"),
    ("bul", "MelodAI – NLP-based music recommendation system"),
    ("bul", "Expensly AI – AI-powered personal finance tracker"),
]
